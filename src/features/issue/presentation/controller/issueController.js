...
class IssueController {
    ...
    updateIssue = expressAsyncHandler(async (req, res) => {
        ...
        const issueData = new Issue({ issueId: issue.id, adminId: req.body.updatedBy, action: "updated an issue", reason: "to improve traching", details: "updated an issue", feature: "Issue Management" });
