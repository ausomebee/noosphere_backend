...
class TenantRoutes {
    ...
    initializeRoutes() {
        ...
        /**
         * @swagger
         * /api/v1/tenant/organization/tenant:
         *   patch:
         *     summary: Update tenant details
         *     description: Update the details of an existing tenant by specifying the tenant ID.
         *     tags: [Tenant]
         ...
         *         description: Bad request
         */
        this.router.patch("/organization/tenant", staffProtect(), TenantDto.updateTenantDto, this.controller.updateTenant);
        ...
        */
        ...
        /**
         * @swagger
         * /api/v1/tenant/getstaffwithpayrollbydate/tenant/{tenantId}:
         *   get:
         ...
         *         description: Internal server error
         */
        this.router.get("/getstaffwithpayrollbydate/tenant/:tenantId", staffProtect(), this.controller.findStaffWithPayrollByTenantAndDateRange);
