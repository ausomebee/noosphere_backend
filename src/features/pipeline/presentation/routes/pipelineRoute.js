...
class PipelineRoutes {
    ...
    initializeRoutes() {
        ...
        /**
         * @swagger
         * /api/v1/pipeline/item/stage/client/tenant/{pipelineStageId}:
         *   get:
         *     summary: Get pipeline items (clients) by stage ID 
         *     tags: [PipelineItem]
         *     parameters:
         ...
         *         description: Validation error
         */
        this.router.get("/item/stage/client/tenant/:pipelineStageId", staffProtect(), PipelineDto.getItemByStageIdDto, this.controller.getItemByStageIdClient);
        ...
        /**
         * @swagger
         * /api/v1/pipeline/tenant/overview/{tenantId}:
         *   get:
         *     summary: Get pipeline overview
         *     tags: [Pipeline]
         *     parameters:
        ...
        this.router.get("/tenant/overview/:tenantId", staffProtect(), this.controller.getTenantPipelineSummary);
