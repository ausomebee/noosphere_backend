...
class BillingDto {
    ...
    static payPaymentLinkDto = (req, res, next) => {
        const schema = Joi.object({
            ...
            transactionRef: Joi.string().trim().allow("").optional(),
            amount: Joi.number().required(),
            cardType: Joi.string().trim().required(),
            lastFourDigits: Joi.string().trim().required(),
            gatewayToken: Joi.string().trim().allow("").optional(),
    ...
    static updateNotificationEmailDto = (req, res, next) => {
        const schema = Joi.object({
            id: Joi.string().uuid().required().messages({
                "string.empty": "ID is required",
                "string.guid": "ID must be a valid UUID"
    ...
    static updateWarningMailDto = (req, res, next) => {
        const schema = Joi.object({
            id: Joi.string().uuid().required().messages({
                "string.empty": "ID is required",
                "string.guid": "ID must be a valid UUID"
    ...
    static updateCancelMailDto = (req, res, next) => {
        const schema = Joi.object({
            id: Joi.string().uuid().required().messages({
                "string.empty": "ID is required",
                "string.guid": "ID must be a valid UUID"
